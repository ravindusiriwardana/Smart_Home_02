    ...
    <section
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, rgba(0,200,160,0.08) 0%, transparent 60%, rgba(255,185,50,0.05) 100%)",
          zIndex: 1,
        }}
      />
      ...
      <div
        style={{
          ...
          opacity: 0.04,
          backgroundImage:
            "repeating-linear-gradient(0deg, #00c8a0 0, #00c8a0 1px, transparent 1px, transparent 60px), repeating-linear-gradient(90deg, #00c8a0 0, #00c8a0 1px, transparent 1px, transparent 60px)",
        }}
      />
      ...
      <div
        ...
        <p
          ...
          Monitor every watt, track solar generation, and get AI-powered
          insights — all from one intelligent dashboard built on{" "}
          {summary?.totalRecords?.toLocaleString() || "500K+"} real energy
          records.
        </p>
        ...
        <div
          ...
          <button
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = "rgba(0,200,160,0.28)";
        ...
        {summary && (
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <StatPill
              ...
              value={`${summary.totalUse?.toLocaleString()} kW`}
              color={T.coral}
            />
            <StatPill
              label="Solar Generated"
              value={`${summary.totalGen?.toLocaleString()} kW`}
              color={T.amber}
            />
            <StatPill
              label="Self-sufficiency"
              value={`${summary.selfSufficiencyPct}%`}
              color={T.teal}
            />
            <StatPill
              label="Avg Temperature"
              value={`${summary.avgTemp}°F`}
              color={T.purple}
            />
          </div>
        )}
        ...
        <div
          ...
          {CARDS.map((c, i) => (
            <div
              ...
              <div style={{ fontSize: 20, color: c.color, marginBottom: 6 }}>
                {c.icon}
              </div>
  ...
  const FEATURES = [
    {
      ...
      desc: "Every appliance tracked minute-by-minute across 503,910 data points spanning 7 days of continuous recording.",
      color: T.teal,
    },
    {
      icon: "☀",
      title: "Solar Intelligence",
      desc: "Track your solar generation vs grid consumption and maximise self-sufficiency with intelligent forecasting.",
      color: T.amber,
    },
    {
      icon: "◉",
      title: "AI-Powered Insights",
      desc: "Natural language queries powered by Claude AI — ask about peak hours, efficiency, or appliance anomalies.",
      color: T.coral,
    },
    {
      icon: "⚡",
      title: "Cost Calculator",
      desc: "Convert kWh readings to real electricity costs. Set your local tariff and see exactly what each device costs.",
      color: T.purple,
    },
    {
      icon: "⌁",
      title: "Weather Correlation",
      desc: "Understand how temperature, humidity and cloud cover drive energy spikes so you can plan ahead.",
      color: "#38bdf8",
    },
    {
      icon: "▦",
      title: "Appliance Breakdown",
      desc: "14 individual appliances monitored simultaneously — from the furnace to the wine cellar — ranked by consumption.",
      color: "#4ade80",
    },
  ];
        ...
        <div
          ...
          <div>
            ...
            <h2
              ...
              Built for homes that
              <br />
              <span style={{ color: T.teal }}>think smarter</span>
            </h2>
            <p
              style={{
                fontSize: 15,
              ...
              This platform ingests raw sensor data from a real Canadian
              household, processes it through a MongoDB pipeline, and surfaces
              patterns that would take hours to find manually.
            </p>
            <p style={{ fontSize: 15, color: T.textSub, lineHeight: 1.8 }}>
              Whether you want to cut your electricity bill, optimise solar
              usage, or just understand your home better — the data is here and
              the AI is ready to help.
            </p>
                ...
                <div key={i}>
                  <div
                    style={{
                      ...
                      fontWeight: 800,
                      fontFamily: T.mono,
                      color: [T.teal, T.amber, T.coral, T.purple][i],
                    }}>
                    {v}
                  </div>
                  <div style={{ fontSize: 11, color: T.textSub, marginTop: 2 }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  "radial-gradient(circle, rgba(0,200,160,0.12) 0%, transparent 70%)",
                zIndex: -1,
              }}
            />
          </div>
        ...
        <div
          ...
          {FEATURES.map((f, i) => (
            <div
              ...
              <div style={{ fontSize: 18, color: f.color, marginBottom: 8 }}>
                {f.icon}
              </div>
              <div
                style={{
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p
            ...
            Convert between kWh, units, and real electricity costs using your
            local tariff rate.
          </p>
        </div>
              ...
              {(mode === "kwh-to-cost" || mode === "cost-to-kwh") && (
                <div>
                  ...
                  <input
                    ...
                    step="any"
                    placeholder={
                      mode === "kwh-to-cost" ? "e.g. 150" : "e.g. 25.00"
                    }
                    value={kwh}
              ...
              {result ? (
                <>
                  <div
                    ...
                    {result.primaryLabel.toUpperCase()}
                  </div>
                  <div
                    style={{
                      fontSize: 38,
...
function ConsumptionGraph() {
  ...
  const chartData = rec
    ? APPLIANCE_KEYS.map((k, i) => ({
        ...
        value: parseFloat(
          (rec[view === "avg" ? `${k}_avg` : `${k}_total`] || 0).toFixed(3),
        ),
        ...
        <div
          ...
          <div>
            ...
            <p style={{ fontSize: 14, color: T.textSub }}>
              See exactly which device is costing you the most — by day.
            </p>
          </div>
              ...
              <div
                ...
                <div
                  style={{
                    ...
                    borderRadius: 12,
                    padding: "14px 18px",
                    borderLeft: `3px solid ${topAppliance.color}`,
                  }}>
                  <div
                    style={{
                      fontSize: 10,
            ...
            <div
              ...
              <ResponsiveContainer width="100%" height={360}>
                <BarChart
                  ...
                  <YAxis
                    stroke={T.textMuted}
                    tick={{ fontSize: 11, fill: T.textSub, fontFamily: T.mono }}
                    tickFormatter={(v) => `${v}`}
                  />
                  <Tooltip
