...
const NAV = [
  ...
  {
    path: '/analytical', label: 'Analytics',
    icon: (
      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        return (
          <button
            ...
            style={{
              ...
              borderRadius: 40,
              border: active ? '1px solid rgba(0,200,160,0.35)' : '1px solid transparent',
              cursor: 'pointer',
              background: active ? 'rgba(0,200,160,0.16)' : isHovered ? 'rgba(0,200,160,0.07)' : 'transparent',
